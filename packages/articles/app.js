...
Articles.register(function(app, auth, database) {
  ...
  Articles.menus.add({
    'roles': ['editor','admin'],
    'title': 'Meine Reisetouren',
    'link': 'all articles'
  });
  Articles.menus.add({
    'roles': ['editor','admin'],
    'title': 'Neue Reisetour erstellen',
    'link': 'create article'
  });

  //We are overriding the default layout of system and instead using the layouts found locally within this package in /server/views
